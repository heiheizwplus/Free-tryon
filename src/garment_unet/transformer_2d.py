...
from src.garment_unet.attention import BasicTransformerBlock
...
class Transformer2DModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        # 2. Blocks
        for block in self.transformer_blocks:    #因为一个transformerblock只有一个self attention，所以不用list保存直接返回
