...
from src.human_unet.attention import AdaGroupNorm
from src.human_unet.attention_processor import Attention, AttnAddedKVProcessor, AttnAddedKVProcessor2_0
from diffusers.models import DualTransformer2DModel
from diffusers.models.resnet import Downsample2D, FirDownsample2D, FirUpsample2D, KDownsample2D, KUpsample2D, ResnetBlock2D, Upsample2D
from src.human_unet.transformer_2d import Transformer2DModel
    ...
    def forward(
        ...
        for i,(attn,resnet) in enumerate(zip(self.attentions, self.resnets[1:])):
            hidden_states = attn(
                ...
                return_dict=False,
                self_attn_state=self_attn_state[i] if self_attn_state is not None else None
            )[0]
            hidden_states = resnet(hidden_states, temb)
