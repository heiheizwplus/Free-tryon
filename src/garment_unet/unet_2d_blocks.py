...
from src.garment_unet.attention import AdaGroupNorm
from src.garment_unet.attention_processor import Attention, AttnAddedKVProcessor, AttnAddedKVProcessor2_0
from diffusers.models.dual_transformer_2d import DualTransformer2DModel
from diffusers.models.resnet import Downsample2D, FirDownsample2D, FirUpsample2D, KDownsample2D, KUpsample2D, ResnetBlock2D, Upsample2D
from src.garment_unet.transformer_2d import Transformer2DModel
...
class UNetMidBlock2DCrossAttn(nn.Module):
    ...
    def forward(
        ...
        self_attn_states=[]  #记录一个mid block中所有self attention层的输入
        cross_attn_outputs=[]
...
class CrossAttnDownBlock2D(nn.Module):
    ...
    def forward(
        ...
        self_attn_states=[]  #记录一个CrossAttnDownBlock2D中所有self attention层的输入
        cross_attn_outputs=[]
...
class CrossAttnUpBlock2D(nn.Module):
    ...
    def forward(
        ...
        self_attn_states,cross_attn_outputs=[],[]  #记录一个CrossAttnUpBlock2D中所有self attention层的输入
